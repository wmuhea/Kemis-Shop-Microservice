...
public class UserApiController {
    ...
    public ResponseBean createAccount(
        ...
        Role accountRoleEnum = Role.findByLabel(accountRequestDto.getType());
        AccountType accountTypeSavedInDb = accountService.getAccountType(accountRoleEnum);
    ...
    public ResponseBean getAccounts(
        ...
        Page<AccountResponseDto> accountResponseDtos =
                accountService.getAccounts(page, size, Role.findByLabel(acctType));
